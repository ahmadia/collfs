...
struct _zipimporter {
    ...
    PyObject *file;     /* Python FILE pointer to Zip archive */
};
...
/* forward decls */
static PyObject *read_directory(ZipImporter *self, char *archive);
static PyObject *get_data(ZipImporter *self, char *archive, PyObject *toc_entry);
...
zipimporter_init(ZipImporter *self, PyObject *args, PyObject *kwds)
{
    ...
    if (path != NULL) {
        ...
        fp = fcollfs_open(buf, "rb");
        file = PyFile_FromFile(fp, buf, "rb", fclose);
...
zipimporter_get_data(PyObject *obj, PyObject *args)
{
    ...
    return get_data(self, PyString_AsString(self->archive), toc_entry);
}
...
*/
static PyObject *
read_directory(ZipImporter *self, char *archive)
{
    PyObject *files = NULL;
    FILE *fp;
...
static PyObject *
get_data(ZipImporter *self, char *archive, PyObject *toc_entry)
{
